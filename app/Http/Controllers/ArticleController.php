...
class ArticleController extends Controller
{
    ...
    public function index()
    {
        ...
        $random_articles = $articles->random(0) ?: $articles->random(3);

        $users = User::all();
        $people = $users->random(0) ?: $users->random(3);
        $now = Carbon::now();

        return view('Article.index', compact('articles', 'random_articles', 'people', "now"));
    }
