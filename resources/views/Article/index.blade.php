...
<div class="card mb-3 post-box shadow">
    ...
    <h4 class="card-text post-body m-4 text-bold">Hello {{ auth()->user()->name }} </h4>
    <p class="card-text post-body m-4">Current time is {{ $now }} and this is best time to post new blog</p>
</div>
@endauth
